...
import CourseControlPage from './components/administrator/CourseControlPage.jsx'
...
import AnalystDashboard from './pages/data_analyst/Dashboard'
  ...
  return (
    <div>
      <Routes>
        ...
        <Route path="/admin/course-control/:courseId" element={<CourseControlPage />} />
