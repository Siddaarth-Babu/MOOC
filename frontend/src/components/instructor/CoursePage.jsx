                  ...
                  <div>
                    ...
                    <div className="section-content">
                      {course.sections?.general?.map((item) => (
                        <div key={item.id} className="instructor-item" style={{ position: 'relative', paddingLeft: '3.5rem' }}>
                          <button className="instructor-delete-item-btn" onClick={() => handleDeleteItem('general', item.id, item.title)} style={{ position: 'absolute', left: 0, top: '50%', transform: 'translateY(-50%)', background: '#e74c3c', color: 'white', border: 'none', borderRadius: '50%', width: '24px', height: '24px', fontSize: '16px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 2px 6px rgba(0,0,0,0.15)' }}>−</button>
                  ...
                  <div>
                    ...
                    <div className="section-content">
                      {course.sections?.materials?.map((item) => (
                        <div key={item.id} className="instructor-item" style={{ position: 'relative', paddingLeft: '3.5rem' }}>
                          <button className="instructor-delete-item-btn" onClick={() => handleDeleteItem('materials', item.id, item.title)} style={{ position: 'absolute', left: 0, top: '50%', transform: 'translateY(-50%)', background: '#e74c3c', color: 'white', border: 'none', borderRadius: '50%', width: '24px', height: '24px', fontSize: '16px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 2px 6px rgba(0,0,0,0.15)' }}>−</button>
                          <span className="item-icon">{item.icon}</span>
                          <span className="item-title">{item.title}</span>
                        </div>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="section-content">
                      {course.sections?.assignments?.map((item) => (
                        <div key={item.id} className="instructor-item" style={{ position: 'relative', paddingLeft: '3.5rem' }}>
                          <button className="instructor-delete-item-btn" onClick={() => handleDeleteItem('assignments', item.id, item.title)} style={{ position: 'absolute', left: 0, top: '50%', transform: 'translateY(-50%)', background: '#e74c3c', color: 'white', border: 'none', borderRadius: '50%', width: '24px', height: '24px', fontSize: '16px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 2px 6px rgba(0,0,0,0.15)' }}>−</button>
                          <span className="item-icon">{item.icon}</span>
                          <span className="item-title">{item.title}</span>
                        </div>
                      ))}
                    ...
                    <div>
                      ...
                      <div className="section-content">
                        {(course.sections[key] || []).map((item) => (
                          <div key={item.id} className="instructor-item" style={{ position: 'relative', paddingLeft: '3.5rem' }}>
                            <button className="instructor-delete-item-btn" onClick={() => handleDeleteItem(key, item.id, item.title)} style={{ position: 'absolute', left: 0, top: '50%', transform: 'translateY(-50%)', background: '#e74c3c', color: 'white', border: 'none', borderRadius: '50%', width: '24px', height: '24px', fontSize: '16px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 2px 6px rgba(0,0,0,0.15)' }}>−</button>
                            <span className="item-icon">{item.icon}</span>
                            <span className="item-title">{item.title}</span>
                          </div>
                        ))}
