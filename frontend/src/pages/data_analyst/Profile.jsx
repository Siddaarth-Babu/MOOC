...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      ...
      try {
        ...
        const url = `http://127.0.0.1:8000/analyst/profile/${analystId}`
        console.log('Fetching analyst profile from:', url)
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`http://127.0.0.1:8000/analyst/profile/${analystId}`, {
        method: 'PATCH',
        headers,
  ...
  if (!analystId) return <div className="student-loading">Invalid analyst ID</div>
    ...
    <>
      ...
      <div className="profile-page container">
        <div className="profile-header">
          ...
          <div>
            <h2 className="profile-name">{name || 'Data Analyst'}</h2>
        ...
        <div className="profile-grid" style={{ gridTemplateColumns: '1fr' }}>
          <section className="profile-display">
            ...
            <div className="profile-display-row">
              ...
              <div className="profile-display-value">{analystId ?? '—'}</div>
            </div>
